...
pub fn stdlib_lookup(module: &str, item: &str) -> Option<StdSig> {
    ...
    Some(match (module, item) {
        ...
        // কলে বা লুপে ব্যবহারযোগ্য হয়। স্কেলার-শুধু ফাংশনগুলো (দূরত্ব, কোণ,
        // ক্ষেত্রফল/আয়তন সূত্র) legacy `--সি` ব্যাকএন্ডেও কাজ করে; যেগুলো
        // দশমিক[]/দশমিক[][] ছোঁয়, সেগুলো ম্যাট্রিক্সের মতোই legacy ব্যাকএন্ডে
        // অসমর্থিত (নিচে kolom-codegen/src/lib.rs দেখুন)।
